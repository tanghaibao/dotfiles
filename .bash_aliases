...
PATH=/home/tanghaibao/export/maker/exe/jbrowse/bin:$PATH
PATH=$HOME/export/jre1.8.0_31/bin:$PATH
export PATH

export CEGMA=$HOME/export/CEGMA_v2.5
export WISECONFIGDIR=$HOME/export/CEGMA_v2.5/wise2.2.3-rc7/wisecfg
AUGUSTUS_CONFIG_PATH=$HOME/export/maker/exe/augustus/config
export AUGUSTUS_CONFIG_PATH
export PYTHONUSERBASE=$HOME
PYTHONPATH=.:$HOME/lib/python2.7/site-packages/:$HOME/.local/lib/python2.7/site-packages/
