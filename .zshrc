...
export ZSH=/Users/htang/.oh-my-zsh
...
# Need to have this so that zsh can figure out the width of char
...
#PYTHONPATH=.:${PACKAGES}/python/lib/python2.7/site-packages:$HOME/lib/python2.7/site-packages
